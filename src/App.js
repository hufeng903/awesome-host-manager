    ...
    return (
      <li
        ...
        className={`is-clearfix ${
          this.props.selected === this.props.id ? "is-active" : ""
        }`}
      >
    ...
    return (
      <article
        ...
        className={`message is-small ${
          this.props.notice.active ? "" : "is-hidden"
        }`}
      >
...
class App extends Component {
  ...
  render() {
    const { dispatch, categories, enabled, selected, content, hosts } =
      this.props;
  ...
  focusTextarea() {
    if (this.refs.hostContent && this.refs.hostContent.refs.textarea) {
